...
const WithdrawFunds = () => {
    ...
    const url = `https://mr-ubani-back-end-apextradepro.vercel.app/api/requestwithdrawcode/${id}`
    const urlll = `https://mr-ubani-back-end-apextradepro.vercel.app/api/withdraw/${id}`
