...
const DashHome = ({
    ...
    const url3 = `https://mr-ubani-back-end-apextradepro.vercel.app/api/getalltransactions/${id}`
    const url4 = `https://mr-ubani-back-end-apextradepro.vercel.app/api/getalluserplan/${id}`
        ...
        <>
            <div className="DashHomeBody">
                ...
                <div className="DashHomeInfoBox1">
                    <p>Welcome to Apextradepro , You set the level.</p>
                </div>
                <div className="DashHomeInfoBox2">
                    <p>Welcome to Apextradepro </p>
                </div>
                <div className="DashHomeMainContent">
                    ...
                    <div className="DashHomeMainContenReferUsDiv">
                        ...
                        <div className="DashHomeMainContenReferUsDivBox">
                            <input
                                type="text"
                                value={`https://apextradepro.vercel.app/`}
                                readOnly
                            />
