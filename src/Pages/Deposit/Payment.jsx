...
const Payment = () => {
    ...
    const [state, setState] = useState({
        value: `${paymentname === "BTC"? ("bc1q4py8cydakrlsndwnalakx8n3vcllek5g7g2txn"): paymentname === "ETH"? ("0xCb859Cbd2aA387aa9fCD232d2fB7a4ACb25bACF9"):"Chosse a Payment Method"}`,
        copied: false,
      });

      const url = `https://mr-ubani-back-end-apextradepro.vercel.app/api/sendpayment/${id}`
      const url2 = `https://mr-ubani-back-end-apextradepro.vercel.app/api/deposit/${id}`
